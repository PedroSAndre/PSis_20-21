...
//Aux functions
//Deals with socket creation and bidding
...
//Deals with the cretaion of the Auth server sock. It also assigns the address (IP and port) of the Auth Server to the Authserver_sock_addr
